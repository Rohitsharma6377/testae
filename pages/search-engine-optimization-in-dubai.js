      ...
      <ServicePageLayout pages={pages} banners={banners} testimonials={testimonials} faqs={faqs} lookingForText={''}>
        ...
        <section className="text-center px-10 md:px-32 py-20">
          <div className="mx-auto">
            ...
            <div className="text-gray-600 pb-6 mx-auto leading-relaxed mb-12" dangerouslySetInnerHTML={{ __html: points[0][0].text }}></div>
        ...
        <section className="text-center bg-[#F4EBD0] px-10 md:px-32 py-20">
          ...
          <div className="mt-12 w-full grid grid-cols-1 lg:grid-cols-2 text-left mx-auto gap-10">
              {points[4].map((item, index) => (
                <div key={index} className="bg-white rounded-lg p-8 border overflow-hidden">
                  ...
                  <div className="text-2xl text-center lg:text-left mb-2 font-bold">{item.para}</div>
                  <div className='text-gray-600 text-justify' dangerouslySetInnerHTML={{__html: item.text}}></div>
                </div>
              ))}
          </div>
          ...
          <p className="text-gray-600 mx-auto leading-relaxed mt-10">
              By following these steps, businesses can increase their chances of finding a reputable and effective SEO agency that will help them achieve their online marketing goals.
          </p>
        </section>
        ...
        <section className='px-10 md:px-32 py-20'>
            <div className="grid grid-cols-1 lg:grid-cols-3 text-center lg:text-left justify-between gap-10 items-center">
              ...
              <div className="lg:col-span-2 mx-auto">
                ...
                <div className="text-gray-600 mb-6 text-justify" dangerouslySetInnerHTML={{ __html: points[5][0].text }}></div>
