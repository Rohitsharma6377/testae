      ...
      <section className="text-center px-10 md:px-32 py-20">
        <div className="mx-auto">
          ...
          <div className='text-center mb-20'>
            {/* <Image loader={() => points[1][0].media_path} src={`${baseUrl}/${points[1][0].media_path}`} width={250} height={250} alt={points[1][0].media_alt} className="w-32 mx-auto mb-6"/> */}
          ...
          <div className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-10">
            {points[2].map((item, index) => (
              <div key={index} className="bg-white border rounded-lg p-6  hover:shadow-lg transition-shadow duration-300">
                ...
                <h3 className="text-2xl mb-2 font-bold text-gray-800 text-center lg:text-left">{item.para}</h3>
