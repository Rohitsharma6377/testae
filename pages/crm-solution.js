      ...
      <ServicePageLayout pages={pages} banners={banners} testimonials={testimonials} faqs={faqs} lookingForText={''}>
            ...
            <div className="mx-auto">
                ...
                {/* <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-10">
                    ...
                    <div className="border bg-white overflow-hidden rounded-xl p-6 flex flex-col justify-between h-full">
                        <Image loader={() => item.media_path} src={`${baseUrl}/${item.media_path}`} width={250} height={250} alt={item.media_alt} className="w-12 h-12 mb-4" />
        ...
        <section className="text-center px-10 md:px-32 py-20">
          <div className="mb-10">
            ...
            <div className="text-gray-600 mx-auto leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: points[3][0].text }}></div>
