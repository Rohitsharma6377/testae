  ...
  return (
    <>
      <ServicePageLayout pages={pages} banners={banners} testimonials={testimonials} faqs={faqs} lookingForText={''}>
        ...
        <section className="text-center px-10 md:px-32 py-20">
          <div className="mb-10">
            <h1 className="text-3xl font-bold text-black mb-4">{points[3][0].para}</h1>
            ...
            <button className="bg-[#00203f] hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded-lg mb-4">Connect Now</button>
          </div>
