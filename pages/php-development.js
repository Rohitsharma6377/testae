        ...
        <section className="bg-[#F4EBD0] px-10 md:px-32 py-20">
            <div className="mx-auto">
                <div className="text-center mb-10">
                    <h2 className="font-semibold text-gray-800 text-3xl">Why should you choose PHP Development Services?</h2>
                </div>

                <Block2 data={points[1]} />
{/* 
        ...
        <section className="text-center px-10 md:px-32 py-20">
          ...
          <p className="text-gray-600 mx-auto leading-relaxed mt-10">
            Are you ready to enhance your internet visibility? Contact AMITKK today and let us help you build a powerful, dynamic, and secure PHP application that drives your business forward.
          </p>
        </section>
