    ...
    <>
      <ServicePageLayout pages={pages} banners={banners} testimonials={testimonials} faqs={faqs} lookingForText={''}>
        ...
        <section className="bg-[#F4EBD0] px-10 md:px-32 py-20">
            <div className="mx-auto">
                <div className="text-center mb-10">
                    ...
                    <div className="mx-auto mt-2 text-gray-600" dangerouslySetInnerHTML={{ __html: points[1][0].text }}></div>
                </div>
        ...
        <section className="text-center px-10 md:px-32 py-20">
          ...
          <p className="text-gray-600 mx-auto leading-relaxed mt-10">
            Choosing AMITKK for your WordPress development ensures that you get a site that is tailored to your specific requirements, built by experts, and backed by ongoing support and maintenance. Our commitment to quality, transparency, and client satisfaction makes us the ideal partner for your web development projects. Get in touch with us right now to begin developing a website that will help you grow your company.
          </p>
        </section>
