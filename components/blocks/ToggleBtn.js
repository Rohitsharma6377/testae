    ...
    <div>
      <input
        className={`mr-2 mt-[0.3rem] h-3.5 w-8 appearance-none rounded-[0.4375rem] 
                   ${isChecked ? 'bg-green-500' : 'bg-neutral-300'}
                   ...
                   after:bg-neutral-100 after:shadow-[0_0px_3px_0_rgb(0_0_0_/_7%),_0_2px_2px_0_rgb(0,0,0,/_4%)] after:transition-[background-color_0.2s,transform_0.2s] after:content-['']
